...
int keys[NUM_KEYS];
double overhead_lock = 0.0;
double overhead_unlock = 0.0;
...
int main(int argc, char **argv) {
    ...
    printf("[main] Total Overhead estimated: %f\n", overhead_lock + overhead_unlock );
    return 0;
}